...
import { authSetupHandler, authLoginHandler, authCallbackHandler, authStatusHandler, authRefreshHandler, authRefreshStatelessHandler } from './routes/auth.js';
...
export function createApp(): AppServer {
  ...
  router.post('/auth/refresh-stateless', authRefreshStatelessHandler);
